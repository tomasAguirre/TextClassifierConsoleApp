...
namespace TextClassifierConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\jonat\Downloads\FakeNewsNet_TrainingSet.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName: @"real", inputColumnName: @"real", addKeyValueAnnotationsAsText: false)
