...
namespace TextClassifierConsoleApp
{
    public partial class TextClassifier
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath("TextClassifier.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("real");
            if (labelColumn == null)
            {
                throw new Exception("real column not found. Make sure the name searched for matches the name in the schema.");
            }
